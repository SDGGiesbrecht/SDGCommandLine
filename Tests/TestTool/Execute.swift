...
public enum Execute {
  ...
  public static let textOption: Option<StrictString> = Option(
  ...
  private static let colourArgumentType = ArgumentType.enumeration(
    name: UserFacing<StrictString, Language>({ localization in
      switch localization {
      case .english, .unsupported:
        return "colour"
  ...
  private static let colourOption = Option(
    name: UserFacing<StrictString, Language>({ localization in
      switch localization {
      case .english, .unsupported:
        return "colour"
  ...
  private static let iterationsOption = Option(
    name: UserFacing<StrictString, Language>({ localization in
      switch localization {
      case .english, .unsupported:
        return "iterations"
  ...
  internal static let unsatisfiableArgument: ArgumentTypeDefinition<StrictString> =
  ...
  private static let informalOption = Option(
    name: UserFacing<StrictString, Language>({ localization in
      switch localization {
      case .english, .unsupported:
        return "informal"
  ...
  private static let unsatisfiableOption: Option<StrictString> = Option(
    name: UserFacing<StrictString, Language>({ _ in
      return "unsatisfiable"
    }),
