...
# Contributing to SDGCommandLine

Everyone is welcome to contribute to SDGCommandLine!
...
2. **Create a local clone**. `git clone https://github.com/SDGGiesbrecht/SDGCommandLine`
